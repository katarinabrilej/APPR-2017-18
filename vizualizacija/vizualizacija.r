...
umorjeni.urejeno <- stevilo_umorjenih[order(stevilo_umorjenih$Stopnja_umorjenih, decreasing=TRUE), ] %>% .[1:10, ]
graf1 <- ggplot(umorjeni.urejeno) + aes(x = Drzava, y = Stopnja_umorjenih, fill = Drzava) + 
